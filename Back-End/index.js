...
mongoose.connect("mongodb+srv://arjukariyeri:arjun123@cluster0.ofngne0.mongodb.net/e-commerce");
...
//creating uploading endppoint for endpoint
...
const Users = mongoose.model('Users', {
    ...
    cartData: {
        type: Object,  // Change this to store cart data
        default: {}    // Default value as empty object
    },
    date: {
        type: Date,
        default: Date.now,
...
app.post('/addtocart', fetchUser, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to add product to cart. Please try again later." });
    }
});
...
app.get('/getcart', fetchUser, async (req, res) => {
    try {
        ...
        res.status(500).json({ success: false, message: "Failed to fetch cart data. Please try again later." });
    }
});
